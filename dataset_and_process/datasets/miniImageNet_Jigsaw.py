...
class miniImageNet_Jigsaw(miniImageNet):
    r"""miniImageNet for Jigsaw
    """
    def __init__(self, root: str, mode: str="train", patch_sz = 42) -> None:
        ...
        self.transform = JigCluTransform(self.transform, 0.3) # 超参数0.3
